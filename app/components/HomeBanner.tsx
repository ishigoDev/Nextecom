...
return (
    <div className="relative bg-gradient-to-r from-sky-500  to-sky-700 mb-8">
        <div className='mx-auto px-8 py-12 flex flex-col gap-2 md:flex-grow items-center justify-evenly'>
            <div className='mb-8 md:mb-0 text-center'>
                ...
                <p className="text-2xl md:test-5xl text-yellow-400 font-bold">GET 50% OFF</p>
            </div>
